...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${SITE_URL}/microsoft-lens-alternative`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/vflat-alternative`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/scanner-app-no-account`, changeFrequency: "monthly", priority: 0.6 },
